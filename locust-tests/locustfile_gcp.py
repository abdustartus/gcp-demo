...
class ColdplayRushShape(LoadTestShape):
    stages = [
        {"duration": 60,  "users": 100,  "spawn_rate": 10},   # Baseline
        {"duration": 240, "users": 500,  "spawn_rate": 20},   # Stress
        {"duration": 360, "users": 1000, "spawn_rate": 50},   # Spike
        {"duration": 420, "users": 0,    "spawn_rate": 50},   # Cool down
    ]
